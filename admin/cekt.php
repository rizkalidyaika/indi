...
//Menampilkan hari dan tanggal
	...
	$query = mysqli_query($connection,"INSERT INTO pel SET email_t='$email_t'");

	echo "<script>alert('Pesan Berhasil Dikirim Ke Email!')</script>";
}else{
	echo "<script>alert('Maaf, Email Belum Terdaftar!');window.location='email_t.php';</script>";
}
