...
<div class="pagetitle">
  <h1>Input Close Cabut</h1>
  <nav>
	<ol class="breadcrumb">
	  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
	  <li class="breadcrumb-item">Close tiket</li>
	  <li class="breadcrumb-item active">Input Close Cabut</li>
	</ol>
  </nav>
</div><!-- End Page Title -->
<section class="section">
	...
	<div class="card">
		...
		<form action="closecabut_tambah.php" method="post">
		<!-- Multi Columns Form -->
 ...
 <form class="row g-3">
			  <div class="col-md-14">
            	...
            	<select class="js-example-placeholder-single js-states form-control" name="id_cabut"> 
                ...
                ?> 
                 <option value="<?php echo $d['id_cabut']; ?>"> 
                    <?php echo $d['id_cabut']; ?> 
                </option> 
                <?php 
                } 
            ...
            <div class="col-md-14">
            	...
            	<select class="js-example-placeholder-single js-states form-control" name="no_inet"> 
                <option selected=>- pilih data -</option> 
                <?php 
                include "koneksi.php"; 
                $query =mysqli_query($connection, "SELECT * FROM tbtiket_cabut"); 
                while ($d = mysqli_fetch_array($query)) { 
                ?> 
                 <option value="<?php echo $d['no_inet']; ?>"> 
                    <?php echo $d['no_inet']; ?> 
                </option> 
                <?php 
                } 
