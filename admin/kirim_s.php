...
<div class="pagetitle">
  <h1>Kirim Surat Survei</h1>
  <nav>
	<ol class="breadcrumb">
	  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
	  <li class="breadcrumb-item">Kirim</li>
	  <li class="breadcrumb-item active"> Surat Survei</li>
	</ol>
  </nav>
</div><!-- End Page Title -->			
<br>
			 			...
			 			<center>
						 	<div class="row">
						 		<div class="col-md-12">
							 			...
							 			<input type="email" class="form-control" name="email_s" placeholder="Masukkan Email Anda..." required>
						 		</div>
						 	</div>
			 			</center>
					 </div>
