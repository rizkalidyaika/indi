...
include 'koneksi.php';
$nama_k = $_GET['nama_k'];
$query = mysqli_query($connection,"SELECT * FROM tbkaryawan WHERE nama_k ='$nama_k'");
	 ...
	 .mytable{
		 ...
		 width:1500px;
			...
			<div class="col-md-12">
					...
					<input type="number" class="form-control" name="id_k" value="<?php echo $d['id_k'];?>">
					<input type="hidden" name="ik" value="<?php echo $d['id_k'];?>">
			</div>
            <div class="col-md-12">
					<label for="nama_k" class="form-label">Nama</label>
					<input type="text" class="form-control" name="nama_k" value="<?php echo $d['nama_k'];?>">
			</div>
			<div class="col-md-12">
