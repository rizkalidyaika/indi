...
<div class="pagetitle">
  <h1>Input Data Teknisi</h1>
  <nav>
	<ol class="breadcrumb">
	  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
	  <li class="breadcrumb-item">Open tiket</li>
	  <li class="breadcrumb-item active">Input Data Teknisi</li>
	</ol>
  </nav>
</div><!-- End Page Title -->
<section class="section">
	...
	<div class="card">
		...
		<form action="teknisi_tambah.php" method="post">
		<!-- Multi Columns Form -->
	 ...
	 .mytable{
		 ...
		 width:1500px;
                ...
                <div class="col-md-12">
                  ...
                  <input type="number" class="form-control" name="id_teknisi">
                </div>		
                <div class="col-md-12">
