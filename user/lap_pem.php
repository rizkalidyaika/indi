...
<div class="pagetitle">
  <h1>Laporan Pembangunan Jaringan</h1>
  <nav>
	<ol class="breadcrumb">
	  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
	  <li class="breadcrumb-item">Laporan</li>
	  <li class="breadcrumb-item active"> Pembangunan Jaringan</li>
	</ol>
  </nav>
</div><!-- End Page Title -->			
<br>

		<form id="div1"  action="lap_pem.php" method="get" class="form-inline">
			...
			<?php 
			$query=mysqli_query($connection, "SELECT kota FROM tbpembangunan GROUP BY kota");
			...
			<?php 
			$query=mysqli_query($connection, "SELECT sto FROM tbpembangunan GROUP BY sto");
