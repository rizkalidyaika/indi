                ...
                <tr>
                    ...
                    <td><?php echo $no++;?></td>
						...
						<td class="btns">
							...
							<br></td>
						<td class="btns"><a href="kirim_pel.php?email="><?php echo $d['email'];?> <div class="btn btn-warning"><i class="fas fa-envelope"></i>Kirim Surat Kunjungan</div></a>
						</td>
					</tr>
					<?php  } ?>
                                </table>
